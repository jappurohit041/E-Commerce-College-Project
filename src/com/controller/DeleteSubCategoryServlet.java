...
public class DeleteSubCategoryServlet extends HttpServlet{
	...
	protected void service(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		boolean flag = SubCategoryDao.makeSubCategoryDeActive(subCategoryID);
		if(flag) {
			request.setAttribute("msg", "Deleted Sub-Category Successfully");
		}
		else {
			request.setAttribute("msg", "Error Occured while Deleting Sub-Category");
		}
