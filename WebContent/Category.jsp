        ...
        <div class="container">
         <div class="row">
            <div class="col-2 categoryImg">
                    <img  src="https://rukminim1.flixcart.com/flap/128/128/image/29327f40e9c4d26b.png?q=100" height="55px" width="55px">
                    <!-- <p>Grocery</p> -->
                    ...
                    <br><div class="btn-group">
                        ...
                        <div class="dropdown-menu">
                            ...
                            <a class="dropdown-item" href="#">Staples</a>
                            <a class="dropdown-item" href="#">Snacks & Beverages</a>
                            <a class="dropdown-item" href="#">Packaged Food</a>
                            <!-- <div class="dropdown-divider"></div> -->
                            <a class="dropdown-item" href="#">Personal & Baby Care</a>
                            <a class="dropdown-item" href="#">Household Care</a>
                            <a class="dropdown-item" href="#">Daiery & Eggs</a>
                                                </div>
                    </div>
            </div>
            <div class="col-2 categoryImg" >
                
                    <img src="https://rukminim1.flixcart.com/flap/128/128/image/69c6589653afdb9a.png?q=100" height="55px" width="55px">
                    <!-- <p>Electronics</p> -->
                    <br><div class="btn-group">
                        <button type="button" class="btn dropdown-toggle dropdown-toggle-split btn-light DropdownRadiusLeft" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
            ...
            <div class="col-2 categoryImg">
                    ...
                    <img src="https://rukminim1.flixcart.com/flap/128/128/image/82b3ca5fb2301045.png?q=100 "  height="55px" width="55px">
                    <!-- <p>Fashion</p> -->
                    <br><div class="btn-group">
                        <button type="button" class="btn dropdown-toggle dropdown-toggle-split btn-light DropdownRadiusLeft" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
            ...
            <div class="col-2 categoryImg">
                    ...
                    <img src="https://rukminim1.flixcart.com/flap/128/128/image/ee162bad964c46ae.png?q=100" height="55px" width="55px">
                    <!-- <p>Home</p> -->
                    <br><div class="btn-group">
                        <button type="button" class="btn btn-light dropdown-toggle dropdown-toggle-split DropdownRadiusLeft" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
