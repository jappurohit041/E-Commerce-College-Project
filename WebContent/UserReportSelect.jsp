...
<body>
	<%try{
	 ...
	 %>
	 	<form id="msform" action="UserReportServlet" method="post">
		<fieldset>
			<%HashMap<Integer, String> map = UserDao.getUserName();  %>
			<h2 class="fs-title">User Details</h2>
			<div class="row">
				<div class="col">
					<label for="inputProductName">User Name</label> <select id="discountType" 
					class="form-control" name = "userID" style="padding: 8px 16px;" required>
			...
			<input type="submit" name="submit"
				class="btn btn-success success action-button" value="User Report" />
		</fieldset>
	</form>
	 <%} 
	catch(Exception e){
