...
<body>
	<%try{
	 ...
	 %>
	 	<form id="msform" action="CategoryReportServlet" method="post">
		<fieldset>
			...
			<div class="row">
				<div class="col">
					...
					class="form-control" name = "categoryID" style="padding: 8px 16px;" required>
						<option value="">Please select category value</option>
			...
			<input type="submit" name="submit"
				class="btn btn-success success action-button" value="Category Report" style="width: 150px;"/>
		</fieldset>
	</form>
	 <%} 
	catch(Exception e){
