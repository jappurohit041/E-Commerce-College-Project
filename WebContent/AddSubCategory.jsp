...
<body>
	<form id="msform" action="AddSubCategoryServlet" method="post"
		enctype="multipart/form-data">
		<fieldset>
			<h2 class="fs-title">SubCategory Details</h2>
			<div class="row">
				<div class="col-6">
					<label for="inputProductName">SubCategory Name</label> <input
			...
			<div class="row">
				<div class="col">
					<label for="inputCategoryStatus">SubCategory Active</label> <select
